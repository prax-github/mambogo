-- Flyway Migration V2: Create Order Service Schema
-- This migration creates the complete Order Service database schema
...
CREATE INDEX IF NOT EXISTS idx_orders_confirmed_recent ON orders(id, created_at) 
...
BEGIN
    ...
    GROUP BY o.id, o.user_id, o.status, o.total_amount, o.shipping_address, 
             ...
             o.carrier, of.estimated_delivery_date;
END;
$$ LANGUAGE plpgsql;
